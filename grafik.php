<?php
//koneksi ke database
$con= new mysqli("debinajaya.com","debinaja","b2f4P7Yb4e","debinaja_riaurunning");
...
$sql = $con->query("SELECT * FROM uas1");
...
while($data = $sql->fetch_assoc()){
	...
	$temp[] = array('v' => (int)$data['jumlah_pengunjung']);
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	function drawChart() {
		...
		var options = {'title':'Data Pengunjung',
					   'width':500,
					   'height':400};
